...
<pre>rake cucumber_test:update # Make sure you have a vendored copy of Rails and Cucumber
rake cucumber_test:v2.2.2:test

# Test test with Spork:
CUCUMBER_GENERATE_OPTS=--spork rake cucumber_test:v2.2.2:test
</pre>

If it's green, everything is OK. If not, you should see red.

To see a list of all available tasks, run rake -T cucumber_test
